...
18: 0xFFFF
19: CP2W 17
20: NAND 18 // 0xFFFF NAND 0xFFFF = 0
...
24: 0XFF0C
25: CP2W 23
26: NAND 24 // 0xFF0B NAND 0x00FC = 0x00F7
...
104: CPfW 2
105: CP2W 100
106: NAND 0 // (**101 NAND *100) -> (*102 NAND *100) -> 0x00F0 NAND 0xF0F0 = 0xFF0F
...
122: CPfW 2
123: CP2W 118
124: GE 0 // (*118 >= **119) -> (*118 >= *120) -> (32 >= 16) = 1
